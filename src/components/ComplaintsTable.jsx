...
const ComplaintsTable = ({
  ...
  const totalItems = pagination?.total_items || sortedComplaints.length;
  const startIndex = pagination
    ? (pagination.current_page - 1) * (pagination.items_per_page || 20) + 1
    : 1;
  const endIndex = pagination
    ? Math.min(startIndex + sortedComplaints.length - 1, totalItems)
  ...
  // Show table content (either complaints or "No complaints found")
  return (
    <Box>
      <style>
        {`
      ...
      <Box style={{ overflowX: 'auto' }}>
        <Table.Root variant="surface">
          ...
          <Table.Body>
            {isDataFetchComplete && complaints.length === 0 ? (
              <Table.Row>
                  ...
                  <Table.Cell>
                    <Flex gap="2" align="center">
                      <IconButton
                        ...
                        style={{
                          cursor:
                            acceptingComplaints[complaint.id] ||
      ...
      {totalPages > 1 && (
        <Box style={{ marginTop: '20px' }}>
          <Flex align="center" justify="between" wrap="wrap" gap="3">
            <Text size="2" color="gray">
              Showing {startIndex} to {endIndex} of {totalItems} complaints
            </Text>
            <Flex align="center" gap="2">
              <Button
                variant="soft"
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => {
                  ...
                  if (!shouldShow) {
                    if (page === 2 && currentPage > 4) {
                      return (
                        <Text key={`ellipsis-${page}`} size="2" color="gray">
                          ...
                        </Text>
                      );
                    }
